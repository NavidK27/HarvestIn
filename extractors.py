...
def extractInfo(j,company_name,company_id):
    ...
    the total number of results and a list of  profile objects,
...
def extractProfile(jelement,company_name,company_id):
    '''Derive and return  profile object from an element.
    '''
...
def extractInvitation(obj):
    '''Derive and return a  profile object from a JSON object
    ("toMember).
    '''
